...
const story = {
    ...
    chapter2_1: {
        ...
        image: "pictures/desert_temple.jpeg",
        choices: [
    ...
    chapter2_1_1: {
        ...
        image: "pictures/fire_temple.jpeg",
        choices: [
        { text: "Continue", next: "chapter3_1" }
        ]
    },
    ...
    chapter2_1_2: {
        ...
        "(Fight occurs, depending on probability)",
        "Lose - Restart the story.",
        "Win - You overpower the clone and beat him to a pulp. In desperation, he dashes toward the spear and yanks it from the pedestal in a split second.",
    ...
    chapter3_1: {
        ...
        image: "pictures/sky_temple.jpeg",
        choices: [
    ...
    chapter3_1_1: {
        ...
        image: "pictures/sky_path_safe.jpeg",
        choices: [
    ...
    chapter3_1_2: {
        title: "",
        text: [
        "There is a 50% chance to trigger a trap that spawns monsters (x3).",
        "Lose once - Restart the story",
        "Win three times - You finally see the bow again and begin to approach it. As you pick up the bow, you notice something moving in the shadows. Upon closer inspection, you realize it is one of the clones.",
        ...
        image: "pictures/sky_path_trap.jpeg",
        choices: [
        { text: "Continue", next: "chapter3_2" }
        ]
    },
    ...
    chapter3_2: {
        ...
        image: "pictures/town_night.jpeg",
        choices: [
        { text: "Continue", next: "end" }
        ]
    }
